...
let colors_name="slate_nummi"

if exists("g:slate_nummi_style")
    let s:slate_nummi_style = g:slate_nummi_style
else
    let s:slate_nummi_style = 'slate_nummi'
endif

if s:slate_nummi_style == "bw"
    ...
    hi Normal ctermbg=0 ctermfg=15 guibg=#222222 guifg=#d0d0d0 gui=none
...
hi PreProc guibg=bg guifg=#FB9A4B gui=none
